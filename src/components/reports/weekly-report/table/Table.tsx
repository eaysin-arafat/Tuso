...
const WeeklyReportTable = ({
  ...
  return (
    <div className="">
      <div className="mt-2 pt-3 px-8 space-y-[2px] w-full">
        <TitleRow
          title="Average Handling Duration"
          data={avgHandlingDuration}
        />
        <TitleRow
          title="Maximum Handling Duration"
          data={maxHandlingDuration}
        />
        <TitleRow
          title="Minimum Handling Duration"
          data={minHandlingDuration}
        />
      </div>
      <div
        style={{
